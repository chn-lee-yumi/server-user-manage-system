...
var ticketKeyword = flag.String("k", "Keyword", "新建凭据的关键词，作用类似密码，访问/api/Keyword就可以生成凭据")
var port = flag.String("p", "8000", "监听的端口号")
...
func main() {
	...
	http.HandleFunc("/api/"+*ticketKeyword, NewTicket)
